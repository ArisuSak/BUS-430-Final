...
export default function AboutUsPage() {
  ...
  const coreValues = [
    ...
    },
    {
      title: "Excellence",
      description:
        "We maintain the highest standards in everything we do, from code quality to customer service and beyond.",
      ...
      <main className="pt-20">
        ...
        >
          <div className="max-w-6xl mx-auto text-center">
            ...
            >
              We are a passionate team of innovators, engineers, and creative
              minds dedicated to building the future of technology, one solution
              at a time.
            </motion.p>
            <motion.div
              variants={fadeInUp}
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              At Six Senergy, we believe that technology should serve humanity.
              Our mission is to create innovative solutions that not only
              advance technological capabilities but also improve lives, foster
              connections, and drive positive change in our communities and
              beyond.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              We combine cutting-edge research with practical application,
              ensuring that our innovations are not just technically impressive,
              but also meaningful and accessible to those who need them most.
            </p>
          </div>
        </motion.section>
