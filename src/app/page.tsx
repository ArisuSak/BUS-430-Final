            ...
            <div className='flex-1 flex flex-col justify-center px-8 lg:px-16 py-20'>
              <div className='max-w-2xl'>
                ...
                <div
                  ...
                  <div className='text-sm text-gray-600 mb-2'>Software Development</div>
                  <div className='text-lg text-gray-900 font-medium'>
                    Build Solutions with <span className='font-bold'>Elegance & Clarity</span>
                  </div>
              ...
              <div className='absolute inset-0 overflow-hidden'>
                ...
                <div
                  ...
                  <div className='flex items-center space-x-3'>
                    ...
                    <div>
                      <div className='text-sm font-semibold text-black '>TechFlow - Enterprise</div>
                      <div className='text-xs text-gray-600 '>React App Delivered May 15</div>
                    </div>
                    <div className='bg-green-100 text-green-800 px-2 py-1 rounded text-xs font-medium'>Live</div>
                  </div>
                </div>
                ...
                <div
                  ...
                  <div className='flex items-center space-x-3'>
                    ...
                    <div>
                      <div className='text-sm font-semibold text-black '>Project Completion</div>
                      <div className='text-xs text-gray-600'>Mobile App & API</div>
                    </div>
                    <div className='bg-green-100 text-green-800 px-2 py-1 rounded text-xs font-medium'>Done</div>
                  </div>
                </div>
                ...
                <div className='absolute top-1/3 left-16'>
                  <svg width='60' height='40' viewBox='0 0 60 40' className='text-gray-600 opacity-30'>
                    <path d='M10 20 Q30 10 50 20 Q30 30 10 20' stroke='currentColor' strokeWidth='2' fill='none' />
                    <path d='M15 25 Q30 15 45 25 Q30 35 15 25' stroke='currentColor' strokeWidth='1' fill='none' />
                  </svg>
                </div>
              </div>
                ...
                <div className='bg-black rounded-3xl p-2 shadow-2xl'>
                  <div className='bg-white rounded-2xl p-6 w-80 h-[600px] relative overflow-hidden'>
                    ...
                    <div className='text-center mb-8'>
                      ...
                      <h3 className='text-xl font-bold text-black mb-1'>Six Senergy</h3>
                    ...
                    <div className='text-center mb-6'>
                      ...
                      <div className='text-xl font-bold text-gray-600 '>Projects • 150+ Delivered</div>
                    </div>
              ...
              {[
                {
                  ...
                  description: 'One of my best development projects and I will tell you how I architected it.',
                  image: '/ecom.png',
                  delay: '0ms',
                },
                {
                  ...
                  description: 'I built an AI solution for 6 months and I would like to share with you my experience.',
                  image: '/ai.png',
                  delay: '200ms',
                },
                {
                  ...
                  description: 'A comprehensive mobile solution that transformed how users interact with our platform.',
                  image: '/mobile.png',
                  delay: '400ms',
                },
              ].map((project, index) => (
          ...
          <div className='max-w-7xl mx-auto'>
            <div className='flex justify-between items-center mb-16'>
              <div>
                ...
                <p className='text-gray-600 text-lg max-w-2xl'>
                  We collaborate with top technology companies to deliver cutting-edge solutions that power your digital
              ...
              {partners.map((partner, index) => (
                <div
                  ...
                  <div className='absolute top-4 right-4'>
                    <span className='px-3 py-1 bg-black text-white text-xs font-medium rounded-full'>{partner.tier}</span>
                  </div>
                  ...
                  <div className='space-y-4'>
                    <div>
                      ...
                      <p className='text-gray-700 font-medium text-sm uppercase tracking-wide'>{partner.category}</p>
                    </div>
            ...
            <div className='mt-16 text-center'>
              <div className='bg-black rounded-2xl p-12 text-white'>
                <h3 className='text-2xl font-semibold mb-4'>Ready to leverage our technology partnerships?</h3>
                <p className='text-gray-300 mb-8 max-w-2xl mx-auto'>
                  Get access to enterprise-grade solutions and expert support from our certified partner network.
                </p>
